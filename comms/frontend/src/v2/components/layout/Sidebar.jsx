const routes = [
  ...
  { path: '/workspace', label: 'Workspace', icon: WorkspaceIcon },
      ...
      <div className="mt-8 pt-6 border-t border-slate-800">
        <div className="px-4">
          ...
          <div className="space-y-1">
            <button className="w-full flex items-center gap-3 px-4 py-2 rounded-lg text-sm text-slate-400 hover:text-slate-200 hover:bg-slate-800/50 transition-colors">
